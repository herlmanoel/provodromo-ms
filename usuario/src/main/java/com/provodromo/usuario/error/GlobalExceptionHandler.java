package com.provodromo.usuario.error;

import com.provodromo.usuario.error.exception.CredenciaisInvalidasException;
import com.provodromo.usuario.error.exception.RegraNegocioException;
import com.provodromo.usuario.error.response.ErrorResponse;
